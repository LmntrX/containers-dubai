...
const Contact = () => (
  <section className="Contact" id="contact">
    <div className="div_Contact_contactData">
      ...
      <p>
        <span className="span_Contact_addressline1"> Al Mabrooka Building, Bank Street, Bur Dubai, Dubai UAE</span>
        <span className="span_Contact_addressline2">
        <br />
        {(window.innerWidth<578?<br/>:"")}
        info@containersdubai.com <br /></span>
        <span className="span_Contact_addressline3">
        {(window.innerWidth<578?<br/>:"")}
        +971506817932 / +971565418329
        </span>
      </p>
    </div>
  </section>
